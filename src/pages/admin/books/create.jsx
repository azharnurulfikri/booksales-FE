...
export default function BookCreate() {
    ...
    // [PERBAIKAN 1]: genre_id dan author_id diubah jadi "" (string kosong) agar reset dropdown berfungsi
    ...
    // [PERBAIKAN 2]: Membuat fungsi khusus untuk Reset Form
    const handleReset = () => {
        setFormData({
            title: "",
            price: 0,
        ...
        // Opsional: Menghapus teks nama file di input file secara visual
        const fileInput = document.getElementById("cover_photo");
        if (fileInput) fileInput.value = "";
    };

    const handelSubmit = async (e) => {
        // [PERBAIKAN 3]: Typo preventDevault -> preventDefault
        e.preventDefault(); 

        try {
            const payload = new FormData(); // Saya ganti 'playload' jadi 'payload' agar lebih baku
    ...
    return (
        <section className="bg-white dark:bg-gray-900">
            <div className="max-w-2xl px-4 py-8 mx-auto lg:py-16">
                ...
                {/* [PERBAIKAN 4]: Menambahkan onSubmit ke form dan menghapus action="#" */}
                <form onSubmit={handelSubmit}>
                    <div className="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                        ...
                        <div className="w-full">
                            ...
                            {/* [PERBAIKAN 5]: name="Stok" dan id="Stok" diubah jadi "stock" */}
                            <input
                                type="number"
                                name="stock" 
                                id="stock"
                        ...
                        <div className="w-full">
                            ...
                            <select
                                ...
                                required
                            >
                                {/* Hapus defaultValue="" di tag select, cukup pakai value="" di option ini */}
